...
def init():
    ...
    @click.option(
        '--image-instance-type', default='t2.medium',
        help='EC2 Instance Type'
    )
    @click.option(
        '--image-instance-key', default='ms-aws-shared.pem',
        help='EC2 SSH Key'
    )
    @click.option(
        '--image-instance-role', default='EC2ImageBuild',
        help='EC2 Instance Role'
    )
    @click.option(
        '--image-instance-secgroup-ids', default='sg-96ebffe6',
        help='EC2 Instance SecurityGroups'
    )
    @click.option(
        '--image-subnet-id', default='subnet-d2164c88',
    ...
    def create(
        ...
        stage_1_image = ec2client.create_image(
